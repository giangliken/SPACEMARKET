    ...
    public partial class InKhachHang : Form
    {
        ...
        private void InKhachHang_Load(object sender, EventArgs e)
        {
            ...
            if (inKH != null && inKH.Any())
            {
                ...
                this.reportViewer1.LocalReport.ReportPath = @"D:\Tai Lieu Hoc Tap\Lap Trinh Tren Moi Truong Windows\Do an\SpaceMarket\SpaceMarket\Bao cao\ReportKhachHang.rdlc";
