...
namespace SpaceMarket.Bao_cao
{
    public partial class InPhieuGiaoHang : Form
    {
        ...
        private void InPhieuGiaoHang_Load(object sender, EventArgs e)
        {
            ...
            this.reportViewer1.LocalReport.ReportPath = @"D:\Tai Lieu Hoc Tap\Lap Trinh Tren Moi Truong Windows\Do an\SpaceMarket\SpaceMarket\Bao cao\ReportGiaoHang.rdlc";
