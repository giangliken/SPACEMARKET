    ...
    public partial class InNhaCungCap : Form
    {
        ...
        private void InNhaCungCap_Load(object sender, EventArgs e)
        {
            ...
            if (inNCC != null && inNCC.Any())
            {
                ...
                this.reportViewer1.LocalReport.ReportPath = @"D:\Tai Lieu Hoc Tap\Lap Trinh Tren Moi Truong Windows\Do an\SpaceMarket\SpaceMarket\Bao cao\ReportNhaCungCap.rdlc";
